        ...
        <div className="flex items-center justify-between">
          <button onClick={() => navigate('home')} className="flex items-center gap-3 group">
            <div className="relative">
              <div className="w-12 h-12 bg-gradient-to-br from-rose-500 via-pink-500 to-orange-400 rounded-xl flex items-center justify-center transform group-hover:scale-105 group-hover:rotate-3 transition-all shadow-lg shadow-rose-500/25">
                <span className="text-white font-bold text-xl tracking-tight">PL</span>
              </div>
            </div>
            <div className="hidden sm:block">
              ...
              <div className="text-xs text-gray-500 tracking-[0.2em]">RENTAL</div>
            </div>
          </button>
          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              ...
              <button
                ...
                className="hidden lg:flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-rose-500 to-orange-400 hover:shadow-lg hover:shadow-rose-500/25 hover:-translate-y-0.5 transition-all font-medium text-sm"
              >
                <Icons.User />
                <span>Login</span>
              </button>
              ...
              <div className="pt-4 mt-4 border-t border-white/10">
                {user ? (
                  <>
                    ...
                    <button onClick={logout} className="w-full py-3 px-4 rounded-xl text-left text-rose-400">
                      Logout
                    </button>
                  </>
                ) : (
                  <button
                    onClick={() => setLoginModal(true)}
                    className="w-full py-3 rounded-xl bg-gradient-to-r from-rose-500 to-orange-400 font-medium"
                  >
                    Login / Register
                  </button>
                )}
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-orange-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
              ...
              <span className="bg-gradient-to-r from-rose-400 via-pink-400 to-orange-400 bg-clip-text text-transparent">Responsibility.</span><br />
            ...
            <div className="flex flex-wrap gap-4 mb-16">
              <button
                ...
                className="group flex items-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-rose-500 to-orange-400 font-semibold text-lg hover:shadow-2xl hover:shadow-rose-500/30 transition-all transform hover:-translate-y-1"
              >
                {cmsData.heroCTA}
                <Icons.ArrowRight />
              </button>
            ...
            <div className="flex flex-wrap gap-12">
              {[
                ...
                <div key={i} className="text-center">
                  <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-rose-400 to-orange-400 bg-clip-text text-transparent">{stat.value}</div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-16">
            <div>
              <span className="text-rose-400 text-sm font-semibold tracking-widest uppercase">What We Do</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {cmsData.services.map((service, i) => (
              <div
                key={i}
                className="group relative rounded-3xl overflow-hidden bg-gradient-to-b from-white/5 to-transparent border border-white/10 hover:border-rose-500/30 transition-all duration-500 hover:-translate-y-2"
              >
                {/* Image */}
      ...
      <section className="py-24 bg-gradient-to-b from-slate-900/50 to-transparent">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            <div>
              <span className="text-rose-400 text-sm font-semibold tracking-widest uppercase">Top Gear</span>
              <h2 className="text-4xl md:text-5xl font-bold mt-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                Featured Equipment
              </h2>
            </div>
            <button
              onClick={() => navigate('equipment')}
              className="flex items-center gap-2 text-rose-400 hover:text-rose-300 font-medium group"
            >
              View Full Catalog 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {cmsData.equipment.filter(e => e.featured).slice(0, 4).map((item) => (
              <div
                key={item.id}
                className="group relative rounded-2xl overflow-hidden bg-white/5 border border-white/10 hover:border-rose-500/30 transition-all duration-300"
              >
                {/* Featured Badge */}
                ...
                {/* Content */}
                <div className="p-5">
                  <span className="text-xs text-rose-400 font-medium tracking-wide">{item.category}</span>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-white/10">
                    ...
                    <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-rose-500/20 hover:bg-rose-500 text-rose-400 hover:text-white transition-all text-sm font-medium">
                      <Icons.Plus /> Add
                    </button>
                  </div>
                </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  ...
                  <div className="rounded-2xl overflow-hidden aspect-square bg-gradient-to-br from-rose-500 to-orange-400 flex items-center justify-center">
            ...
            {/* Content */}
            <div>
              <span className="text-rose-400 text-sm font-semibold tracking-widest uppercase">Why Pro Level</span>
      ...
      <section className="py-24 bg-gradient-to-b from-slate-900/50 to-transparent">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-rose-400 text-sm font-semibold tracking-widest uppercase">Testimonials</span>
            <h2 className="text-4xl md:text-5xl font-bold mt-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
          ...
          <div className="relative">
            <div className="absolute -top-8 left-0 text-8xl text-rose-500/20 font-serif">"</div>
            ...
            <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 md:p-12">
              ...
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-rose-500 to-orange-400 flex items-center justify-center font-bold text-lg">
            ...
            <div className="absolute -bottom-8 right-0 text-8xl text-rose-500/20 font-serif rotate-180">"</div>
          </div>
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 py-20 px-8 md:px-16 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <button
                  onClick={() => setQuoteModal(true)}
                  className="flex items-center gap-3 px-8 py-4 rounded-2xl bg-white text-rose-600 font-bold text-lg hover:shadow-2xl hover:shadow-black/20 transition-all transform hover:-translate-y-1"
                >
                  Get a Free Quote
                  <Icons.ArrowRight />
                </button>
  ...
  return (
    <div className="pt-32 pb-24 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        {/* Header */}
        <div className="text-center mb-16">
          <span className="text-rose-400 text-sm font-semibold tracking-widest uppercase">Our Inventory</span>
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-12">
          <div className="relative flex-1">
            <input
              ...
              className="w-full px-6 py-4 rounded-2xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none transition-all text-lg"
            />
          </div>
            ...
            {cmsData.categories.map((cat) => (
              <button
                ...
                className={`px-5 py-3 rounded-xl font-medium transition-all ${
                  activeCategory === cat
                    ? 'bg-gradient-to-r from-rose-500 to-orange-400 text-white shadow-lg shadow-rose-500/25'
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredEquipment.map((item) => (
            <div
              key={item.id}
              className="group relative rounded-2xl overflow-hidden bg-white/5 border border-white/10 hover:border-rose-500/30 transition-all duration-300 hover:-translate-y-1"
            >
              {item.featured && (
    ...
    <div className="pt-32 pb-24 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <span className="text-rose-400 text-sm font-semibold tracking-widest uppercase">What We Offer</span>
          <h1 className="text-5xl md:text-6xl font-bold mt-4 mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            Our Services
          </h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
...
function AboutPage() {
  ...
  return (
    <div className="pt-32 pb-24 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <span className="text-rose-400 text-sm font-semibold tracking-widest uppercase">Our Story</span>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-20">
          ...
          <div className="grid grid-cols-2 gap-6">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl bg-gradient-to-br from-rose-500/10 to-transparent border border-rose-500/20 text-center">
                <div className="text-4xl font-bold bg-gradient-to-r from-rose-400 to-orange-400 bg-clip-text text-transparent mb-2">{stat.value}</div>
...
function ContactPage() {
  ...
  return (
    <div className="pt-32 pb-24 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <span className="text-rose-400 text-sm font-semibold tracking-widest uppercase">Get In Touch</span>
          <h1 className="text-5xl md:text-6xl font-bold mt-4 mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            Contact Us
          </h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
          ...
          <div>
            <div className="space-y-6 mb-12">
              {[
                ...
                <div key={i} className="flex items-start gap-5 p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-rose-500/30 transition-all">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-rose-400">{item.subtitle}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
              ...
              <div className="mt-4 pt-4 border-t border-white/10 flex items-center gap-2 text-rose-400">
                <span className="flex h-2 w-2"><span className="animate-ping absolute h-2 w-2 rounded-full bg-rose-400 opacity-75"></span><span className="rounded-full h-2 w-2 bg-rose-500"></span></span>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input type="text" required value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none transition-all" />
                  </div>
                  <div>
                    <label className="block text-sm text-gray-400 mb-2">Email *</label>
                    <input type="email" required value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none transition-all" />
                  </div>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm text-gray-400 mb-2">Phone</label>
                    <input type="tel" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none transition-all" />
                  </div>
                  <div>
                    <label className="block text-sm text-gray-400 mb-2">Company</label>
                    <input type="text" value={formData.company} onChange={(e) => setFormData({ ...formData, company: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none transition-all" />
                  </div>
                </div>
                <div>
                  <label className="block text-sm text-gray-400 mb-2">Message *</label>
                  <textarea required rows="5" value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none transition-all resize-none" />
                </div>
                <button type="submit" className="w-full py-4 rounded-xl bg-gradient-to-r from-rose-500 to-orange-400 font-semibold text-lg hover:shadow-lg hover:shadow-rose-500/25 transition-all">
                  Send Message
                </button>
              </form>
            )}
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-64 shrink-0">
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-1">
              {tabs.map((tab) => (
                <button key={tab.id} onClick={() => setActiveTab(tab.id)} className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${activeTab === tab.id ? 'bg-gradient-to-r from-rose-500 to-orange-400 text-white' : 'hover:bg-white/5 text-gray-400'}`}>
                  {tab.icon} {tab.name}
                </button>
              ))}
            </div>
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <input type="text" value={cmsData.heroTitle} onChange={(e) => setCmsData({ ...cmsData, heroTitle: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none" />
                    </div>
                    <div>
                      <label className="block text-sm text-gray-400 mb-2">Hero Subtitle</label>
                      <input type="text" value={cmsData.heroSubtitle} onChange={(e) => setCmsData({ ...cmsData, heroSubtitle: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none" />
                    </div>
                    <div>
                      <label className="block text-sm text-gray-400 mb-2">About Text</label>
                      <textarea rows="4" value={cmsData.aboutText} onChange={(e) => setCmsData({ ...cmsData, aboutText: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none resize-none" />
                    </div>
                    <button className="px-6 py-3 rounded-xl bg-gradient-to-r from-rose-500 to-orange-400 font-medium">Save Changes</button>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'equipment' && (
                <div>
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-rose-500 to-orange-400 font-medium"><Icons.Plus /> Add Equipment</button>
                  </div>
                    ...
                    {cmsData.equipment.map((item) => (
                      <div key={item.id} className="flex items-center justify-between p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button className="p-2 rounded-lg hover:bg-rose-500/20 text-gray-400 hover:text-rose-400"><Icons.Trash /></button>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              {activeTab === 'technicians' && (
                <div>
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-rose-500 to-orange-400 font-medium"><Icons.Plus /> Add Technician</button>
                  </div>
                  <div className="space-y-3">
                    {technicians.map((tech) => (
                      <div key={tech.id} className="p-4 rounded-xl bg-white/5">
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center gap-3">
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-rose-500 to-orange-400 flex items-center justify-center font-bold">{tech.avatar}</div>
                            <div>
    ...
    <div className="pt-24 pb-24 min-h-screen">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-rose-500/20 to-transparent border border-rose-500/20">
            ...
            <button className="px-4 py-2 rounded-xl bg-gradient-to-r from-rose-500 to-orange-400 font-medium text-sm">Request Quote</button>
          </div>
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
    ...
    <div className="pt-24 pb-24 min-h-screen">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="p-6 rounded-2xl bg-white/5 border border-white/10 mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-rose-500 to-orange-400 flex items-center justify-center text-2xl font-bold">{techInfo?.avatar}</div>
              <div>
        ...
        <div className="p-6 rounded-2xl bg-white/5 border border-white/10 mb-8">
          ...
          <div className="flex flex-wrap gap-2">
            {(techInfo?.certifications || []).map((cert, i) => (
              <span key={i} className="px-4 py-2 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 text-sm">{cert}</span>
            ))}
          </div>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md p-8 rounded-3xl bg-slate-900 border border-white/10">
        ...
        {error && <div className="mb-4 p-3 rounded-xl bg-rose-500/20 text-rose-400 text-sm">{error}</div>}
          ...
          {!isLogin && (
            <>
              <div>
                ...
                <input type="text" required value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none" />
              </div>
              <div>
                <label className="block text-sm text-gray-400 mb-2">Company</label>
                <input type="text" value={formData.company} onChange={(e) => setFormData({ ...formData, company: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none" />
              </div>
            </>
          )}
          <div>
            <label className="block text-sm text-gray-400 mb-2">Email</label>
            <input type="email" required value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none" />
          </div>
          <div>
            <label className="block text-sm text-gray-400 mb-2">Password</label>
            <input type="password" required value={formData.password} onChange={(e) => setFormData({ ...formData, password: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none" />
          </div>
          <button type="submit" className="w-full py-4 rounded-xl bg-gradient-to-r from-rose-500 to-orange-400 font-semibold">{isLogin ? 'Sign In' : 'Create Account'}</button>
        </form>

        <div className="mt-6 text-center">
          <button onClick={() => setIsLogin(!isLogin)} className="text-rose-400 hover:underline">{isLogin ? "Don't have an account? Register" : 'Already have an account? Sign In'}</button>
        </div>
      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8 rounded-3xl bg-slate-900 border border-white/10">
        ...
        {submitted ? (
          <div className="text-center py-12">
            ...
            <button onClick={onClose} className="px-6 py-3 rounded-xl bg-gradient-to-r from-rose-500 to-orange-400 font-medium">Close</button>
          </div>
        ) : (
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div><label className="block text-sm text-gray-400 mb-2">Name *</label><input type="text" required value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none" /></div>
                <div><label className="block text-sm text-gray-400 mb-2">Email *</label><input type="email" required value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none" /></div>
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                <div><label className="block text-sm text-gray-400 mb-2">Phone</label><input type="tel" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none" /></div>
                <div><label className="block text-sm text-gray-400 mb-2">Company</label><input type="text" value={formData.company} onChange={(e) => setFormData({ ...formData, company: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none" /></div>
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                <div><label className="block text-sm text-gray-400 mb-2">Event Date</label><input type="date" value={formData.eventDate} onChange={(e) => setFormData({ ...formData, eventDate: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none" /></div>
                <div><label className="block text-sm text-gray-400 mb-2">Event Type</label><select value={formData.eventType} onChange={(e) => setFormData({ ...formData, eventType: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none"><option value="">Select...</option><option value="corporate">Corporate Event</option><option value="concert">Concert/Festival</option><option value="conference">Conference</option><option value="wedding">Wedding</option><option value="other">Other</option></select></div>
              </div>
              <div><label className="block text-sm text-gray-400 mb-2">Event Description *</label><textarea required rows="4" value={formData.description} onChange={(e) => setFormData({ ...formData, description: e.target.value })} placeholder="Tell us about your event..." className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-rose-500/50 outline-none resize-none" /></div>
              <button type="submit" className="w-full py-4 rounded-xl bg-gradient-to-r from-rose-500 to-orange-400 font-semibold text-lg">Submit Quote Request</button>
            </form>
          </>
        )}
      </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-rose-500 to-orange-400 rounded-xl flex items-center justify-center font-bold">PL</div>
              <div><div className="font-bold">PRO LEVEL</div><div className="text-xs text-gray-500">RENTAL</div></div>
            </div>
